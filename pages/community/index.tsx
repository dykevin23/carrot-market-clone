      ...
      <div className="py-16 px-4 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div className="flex cursor-pointer flex-col items-start" key={i}>
            ...
            <div className="flex items-center justify-between mt-5 w-full text-gray-500 font-medium text-xs">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
            <div className="mt-3 flex space-x-5 text-gray-700 py-2.5 border-t border-b-[2px] w-full">
