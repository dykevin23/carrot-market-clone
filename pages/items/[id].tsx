      ...
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 border font-medium hover:bg-orange-600 border-orange-500 bg-orange-500 py-3 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
              Talk to seller
            </button>
